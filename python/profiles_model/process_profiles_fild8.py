...
def create_parquet_from_profiles(timestamp_str, road_stretch, temp_profiles):
    """
...
# 0 136001   0
    ...
    #dump to parquet
    create_parquet_from_profiles(date_str, road_stretch, temp_profiles)
...
# No files created or modified, only reading from 'fild8_2022022614'
