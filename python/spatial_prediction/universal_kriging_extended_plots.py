...
def plot_variogram_analysis(UK_model, coords, values, title="Variogram Analysis"):
    """
...
def plot_continuous_temperature_map(grid_coords, predictions, grid_shape, title="Temperature Map", 
                                        original_stations=None, predicted_stations=None):
    """
...
year = 2023
date_chosen = datetime(2023,8,11,15)
...
plot_variogram_analysis(UK, coords, values, "Universal Kriging")
...
plot_continuous_temperature_map(grid_coords, grid_predictions, grid_shape, 
                               ...
                               original_stations=gdf_original)
